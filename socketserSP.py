...
def qbsessfnder():
    ...
    # Iterating through all the running processes
    try:
        flag = f.win32_process(name='QBW.EXE')[0].SessionId
    except:
        ("Application is not Running")
    return flag
...
class AppServerSvc (win32serviceutil.ServiceFramework):
    ...
    def start(self):
        ...
        self.isrunning = True #IsRunning('QBW.EXE')  # made change here to auto start without QB running
